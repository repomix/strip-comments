...
[![NPM version](https://img.shields.io/npm/v/@repomix/strip-comments.svg?style=flat)](https://www.npmjs.com/package/@repomix/strip-comments) [![NPM monthly downloads](https://img.shields.io/npm/dm/@repomix/strip-comments.svg?style=flat)](https://npmjs.org/package/@repomix/strip-comments)

> Strip line and/or block comments from a string. Blazing fast, and works with JavaScript, Sass, CSS, Less.js, and a number of other languages.

This is a fork of [strip-comments](https://github.com/jonschlinkert/strip-comments) maintained by the [Repomix](https://github.com/repomix) team for use in the Repomix project. The original project is no longer actively maintained.

Please consider following the original project's author, [Jon Schlinkert](https://github.com/jonschlinkert), and consider starring the project to show your :heart: and support.
...
```sh
$ npm install --save @repomix/strip-comments
```
...
```js
const strip = require('@repomix/strip-comments');
...
Copyright © 2014-present, [Jon Schlinkert](https://github.com/jonschlinkert).
Copyright © 2024-present, [Repomix contributors](https://github.com/repomix).
